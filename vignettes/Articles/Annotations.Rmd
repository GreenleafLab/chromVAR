...
example_counts <- add_gc_bias(example_counts, genome = BSgenome.Hsapiens.UCSC.hg19)
...
# get motif matches
motif_ix <- match_motifs(jaspar_motifs, counts_filtered, genome = BSgenome.Hsapiens.UCSC.hg19)
```
...
```{r}
kmer_ix <- match_kmers(6, counts_filtered, genome = BSgenome.Hsapiens.UCSC.hg19)
```
...
```{r}
my_kmers_ix <- match_kmers(c("AGATAA","GATAAG"), counts_filtered, genome = BSgenome.Hsapiens.UCSC.hg19)
```
