...
test_that("Can read annotations from multiple bed file",{
  ...
  expect_equal(as.matrix(assays(res)$matches)[,1], c(TRUE, FALSE, FALSE))
  expect_equal(as.matrix(assays(res)$matches)[,2], c(FALSE, TRUE, TRUE))
...
test_that("Can get annotations from genomic ranges",{
  ...
  expect_equal(as.matrix(assays(res)$matches)[,1], c(TRUE, FALSE, FALSE))
  expect_equal(as.matrix(assays(res)$matches)[,2], c(FALSE, TRUE, TRUE))
  expect_equal(as.matrix(assays(res)$matches)[,3], c(FALSE, FALSE, FALSE))
