...
setMethod("sampleBackgroundPeaks", "backgroundPeaks",
          function(object, peak_set, counts_mat, niterations = 50){
...
setGeneric("getBackgroundPeakSets", function(counts_mat, ...) standardGeneric("getBackgroundPeakSets"))


setMethod("getBackgroundPeakSets", "fragmentCounts",
          function(counts_mat, niterations = 50, window = 1000, BPPARAM = BiocParallel::bpparam(), for_set = TRUE){
